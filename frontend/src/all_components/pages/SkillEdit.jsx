...
import { addOfferSkill, deleteOfferSkill } from "../../services/skill.service";
      ...
      <section className="bg-white rounded-3xl  p-5 sm:p-8 lg:p-10 max-w-4xl mx-auto sm:shadow-2xl">
        ...
        <form onSubmit={handleAddSkill} className="space-y-6 sm:space-y-8">
          ...
          <div className="text-center">
            <button type="submit"
            className="w-30 h-10 bg-indigo-600 text-white font-medium cursor-pointer  rounded-sm  hover:bg-indigo-600 hover:shadow-xl hover:scale-105">
              {loading ? "Adding..." : "Add+"}
            </button>
          </div>
        </form>
